...
public class SpinnerActivity2 extends AppCompatActivity {
    ...
    ArrayAdapter<CharSequence> adfood; //어댑터를 선언했습니다.
    String choice_food = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("인원별");
        final Spinner spin10 = (Spinner) findViewById(R.id.spinner10);
        final Button btn_refresh10 = (Button) findViewById(R.id.result10);
//xml과 class에 변수들을 연결해줍니다. final를 사용한 이유는 spin2가 함수안에서 사용되기 때문에 코딩전체로 선언한 것입니다.
        adfood = ArrayAdapter.createFromResource(this, R.array.foodof, android.R.layout.simple_spinner_dropdown_item);
...
//R.layout.simple_~~~는 안드로이드에서 기본제공하는 spinner 모양입니다. 다른것도 있는데 비슷합니다.
        adfood.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//이부분이 정확히 말로 설명을 못하겠습니다. 아무튼 필요합니다. 헤헤 고수분들 도와주세요.
        spin10.setAdapter(adfood);
//어댑터에 값들을 spinner에 넣습니다. 여기까지 하시면 첫번째 spinner에 값들이 들어갈 것입니다.
        spin10.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                choice_food = adfood.getItem(i).toString();
//선택된 값을 choice_food에 넣습니다.
            }
        ...
        btn_refresh10.setOnClickListener(new View.OnClickListener() {
            //버튼 클릭시 이벤트입니다.
            @Override
            public void onClick(View view) {
                Toast.makeText(SpinnerActivity2.this, choice_food + " 선택", Toast.LENGTH_SHORT).show();
                //선택된 도 와 시를 Toast로 화면에 보여줍니다.
                Intent intent = new Intent(getApplicationContext(), listActivity2.class);
                //list1 -> list2로 바꿔야
                intent.putExtra("food1", choice_food);
